...
let expName = 'EXP 4.0';  // from the Builder filename that created this script
let expInfo = {
...
psychoJS.start({
  ...
  resources: [
    // resources:
    {'name': '../../../Downloads/exp 4.0 - Sheet1.csv', 'path': '../../../Downloads/exp 4.0 - Sheet1.csv'},
    {'name': '../../../Downloads/exp 4.0 - Sheet1.csv', 'path': '../../../Downloads/exp 4.0 - Sheet1.csv'},
  ]
});
...
function trialsLoopBegin(trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    trials = new TrialHandler({
      ...
      trialList: '/Users/_reemaaaa_18/Downloads/exp 4.0 - Sheet1.csv',
