...
expName = 'EXP 4.0'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/_reemaaaa_18/Desktop/lab in psy 2024/EXP 4.0/EXP 4.0_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    line1 = visual.Rect(
        ...
        ori=90.0, pos=(-150,60), draggable=False, anchor='center',
        lineWidth=1.0,
        colorSpace='rgb', lineColor='white', fillColor='white',
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('/Users/_reemaaaa_18/Downloads/exp 4.0 - Sheet1.csv'), 
        seed=None, 
    )
